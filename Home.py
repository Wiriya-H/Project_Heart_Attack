...
html_1 = """
<div style="background-color:#ffffff;margin-top:40px;padding:5px;border-radius:5px;border-bottom: 3px solid #ffffff;border-top: 3px solid #ffffff;">
...
html_7 = """
<div style="background-color:#ffffff;border-bottom: 3px solid #ffffff;border-top: 3px solid #ffffff;margin-top:20px;">
...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      html_8 = """
      <div style="background-color:#ffffff;padding:20px;border: 3px solid #ffffff;">
